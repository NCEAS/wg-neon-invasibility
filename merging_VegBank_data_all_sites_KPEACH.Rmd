...
NCVS_WV_EB_reduced <- read_csv(file.path(data_output, "NCVS_WV_KPEACH_EB_LP_reduced2.csv"))
...
NCVS_WV_EB_reduced <- NCVS_WV_EB_reduced %>%
  rename(OriginalName = NCVS_original_scientific_name)
...
```{r}
  ...
  #As csv
write.csv(All_VegBank_KPEACH_reduced7,"/home/shares/neon-inv/output_files/All_VegBank_KPEACH_EB_LP_reduced2.csv", row.names = FALSE)
