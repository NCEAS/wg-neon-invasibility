...
NCVS_WV_EB_reduced <- read_csv(file.path(data_output, "NCVS_WV_KPEACH_EB_LP_reduced.csv"))
...
```{r}
  ...
  #As csv
write.csv(All_VegBank_KPEACH_reduced7,"/home/shares/neon-inv/output_files/All_VegBank_KPEACH_EB_LP_reduced.csv", row.names = FALSE)
