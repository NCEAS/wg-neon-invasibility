...
#LP: T stands for trees and N stands for non-vascular. I am keeping them as in the other datasets they were actually kept for the database
...
WestVirginia_comp4  <- WestVirginia_comp3 %>% group_by(Dataset, Zone, UniqueID, Year, Lat, Long, SpCode, Duration, GrowthForm, ExoticStatus, ExoticStatus_Origin, bestname, `Taxon Observation Area`, NCVS_original_scientific_name) %>%
...
#As csv
write.csv(WestVirginia_comp4 ,"/home/shares/neon-inv/output_files/NCVS_WV_KPEACH_EB_LP_reduced2.csv", row.names = FALSE)
